                ...
                <div class="card border-primary">
                    ...
                    <div class="card-body">
                        <form action="#.php" method="post">
                            ...
                            <?php $password_error == 2 ? viewsMsg::alert_message("Votre mot de passe doit être différent de votre nom d'utilisateur, contenir entre 6 et 20 charactères, une majuscule, une minuscule et un chiffre obligatoire et différent de votre pseudo", "danger") : 0; ?>
                            <div class="form-group">
